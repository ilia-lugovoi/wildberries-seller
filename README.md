...
- продажи и маржинальность по товару, региону, бренду, размеру и стране.
  ...
  <img width="1406" height="861" alt="операционный_отчет_продаж" src="screens/операционный_отчет_продаж.png" />
...
Отчет поддерживает анализ на разных уровнях детализации — от категории до SKU — и переключение между дневной, недельной, месячной и квартальной гранулярностью.
  ...
  <img width="1262" height="857" alt="отчет_затоваренности_запасов" src="screens/отчет_затоваренности_запасов.png" />
...
- распределение запасов по складам.
  ...
  <img width="1341" height="853" alt="расположение_динамика_запасов" src="screens/расположение_динамика_запасов.png" />
